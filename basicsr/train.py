...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        ...
        default="Denoising/Options/CLIPDenoisingSimple_LDCTDenoising_GaussianSigma5.yml",
    )
    parser.add_argument(
        "--launcher",
...
def main():
    ...
    # automatic resume ..
    # RN50 CLIP
    state_folder_path = "/home/gabriel/Research/CLIPDenoising/experiments_refine/{}/training_states/".format(
        opt["name"]
    )
        ...
        while train_data is not None:
            ...
            if restoration_model != "ImageCleanModifed2Model":
                ...
                model.feed_train_data(
                    {"lq": lq, "gt": gt, "caption": train_data["caption"]}
                )
